    ...
    function mostrarSegundaEtapa() {
        ...
        if (!validarCPF(cpf)) { $('#erro-cpf').addClass('is-visible').show(); return; } else { $('#erro-cpf').removeClass('is-visible').hide(); }
        if (!validarTelefone(telefone)) { $('#erro-telefone').addClass('is-visible').show(); return; } else { $('#erro-telefone').removeClass('is-visible').hide(); }
